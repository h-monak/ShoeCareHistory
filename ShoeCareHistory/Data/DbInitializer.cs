        ...
        public static void Initialize(ShoeCareHistoryContext context)
        {
            try
            {
                ...
                if (!context.Shoe.Any())
                {
                    var shoes = new Shoe[]
                    {
                    //new Shoe(){ Id = ,Name = "877", Code ="877", ProductName = "CLASSIC-WORKS-MOC-TOE", Color = "ORO-REGACY", Leather = "COWHIDE", ProductionDate = DateTime.Parse("16-11-12"), PurchaseDate = DateTime.Parse("16-11-19"), BreakInDate = DateTime.Parse("18-02-24"), ShoeMaker = redwing }
                ...
                if (!context.CareItem.Any())
                {
                    ...
                    new CareItem(){ Id = 8, Name= "Shoe Cream", CareCategory = CareCategory.Cream, CareBrand = mowbray, Color = "Black" },
                    new CareItem(){ Id = 9, Name= "Cordovan Cream Renovator", CareCategory = CareCategory.Cream, CareBrand = mowbray, Color = "Black" },
                    new CareItem(){ Id = 10, Name= "Bees Aging Oil", CareCategory = CareCategory.Oil, CareBrand = mowbray },
                    new CareItem(){ Id = 11, Name= "Leather Balsam", CareCategory = CareCategory.Oil, CareBrand = renapur },
                    new CareItem(){ Id = 12, Name = "Leather Creaner", CareCategory = CareCategory.Cleaner, CareBrand= lexol },
                    new CareItem(){ Id = 13, Name = "Leather Conditioner", CareCategory = CareCategory.Oil, CareBrand= lexol },
                    new CareItem(){ Id = 14, Name = "Stain Remover", CareCategory = CareCategory.Cleaner,  CareBrand = mowbray },
                    new CareItem(){ Id = 15, Name = "Stain Creansing Water", CareCategory = CareCategory.Cleaner, CareBrand = mowbray },
                    new CareItem(){ Id = 16, Name = "Welt Cream", CareCategory = CareCategory.Cream, CareBrand = mowbray, Color = "Black" },
                    new CareItem(){ Id = 17, Name = "Welt Cream", CareCategory = CareCategory.Cream, CareBrand = mowbray, Color = "Brown" },
